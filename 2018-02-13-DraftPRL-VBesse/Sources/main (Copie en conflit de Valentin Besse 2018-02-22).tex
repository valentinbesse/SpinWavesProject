...
\begin{figure}[ht]
	\centering
	\subfloat[]{\label{fig:schemeGeometry}\includegraphics[width=0.4\columnwidth]{geometry_scheme.eps}}
	\hspace{0.1\columnwidth} 
    \subfloat[]{\label{fig:schemeMovement}\includegraphics[width=0.4\columnwidth]{Movement.eps}}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.95\columnwidth]{dispersionRelation-H6_5T-Ni30nm-3_57ps.eps}
